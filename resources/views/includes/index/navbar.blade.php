<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-navbar py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="index.html" class="js-logo-clone">FORD</a>
            </div>
          </div>
    ...
    @foreach($categories as $category)
        ...
        <li>  <a class="dropdown-item" href="{{ route('shop.category.name', $category->name) }}">{{ $category->name }}</a>     </li>
    @endforeach
</ul>
                </li>
                <li><a href="about.html">About</a></li>
                <li><a href="{{route('contact.showForm')}}">Contact</a></li>
              </ul>
            </nav>
          </div>
          <div class="icons">
